...
`migrations/0009_device_owner.sql` (schema_version 9) adds `devices.owner_id` (see Flasher
sign-in). `migrations/0010_default_playlist.sql` (schema_version 10) adds no columns: it inserts
