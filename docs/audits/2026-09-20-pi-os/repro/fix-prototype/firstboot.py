...
def render_provision(cfg: dict) -> str:
    ...
    lines = [
        ...
        *SCREEN_FN,
        ...
        "  out=$(mktemp) || return 1",
        f'  code=$(ENROLL_KEY="$ENROLL_KEY" DEVICE_ID="$DEVICE_ID" DEVICE_NAME="$DEVICE_NAME" python3 -c {q(body)} \\',
        ...
        '  screen "Setting up this projector" "Try $TRIES did not finish: $REASON" "Trying again in a minute."',
        "  sleep 60",
        "done",
        "",
    ]
